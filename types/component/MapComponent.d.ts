import { TypeName, CapturePriority, MapPattern, CameraMode, CameraPhotoMode, ExecutionEngine, MapDroneOrientationStrategy, MapSpacing, CameraFocusMode, MapPatternLinearStrategy, PathCornering } from "../core/Enums";
...
export declare class MapComponent extends ApproachableComponent implements Serializable {
    ...
    pattern: MapPattern;
    mapPatternLinearStrategy: MapPatternLinearStrategy;
    mapPatternLinearPassCount: number;
    mapPatternLinearCorridorWidth: number;
    mapPatternLinearCornering: PathCornering;
    mapPatternLinearCornerRadius: number;
    ...
    addBoundaryPoints(boundaryPoints: MapComponentBoundaryPoint[], context?: ComponentContext | null): MapComponentBoundaryPoint[];
